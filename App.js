...
function createInitialBoard(seeds=INITIAL_SEEDS){return Array(TOTAL).fill(seeds)}
...
const resetGame=useCallback(()=>{setBoard(createInitialBoard(initialSeeds));setCurrentPlayer(1);setGameOver(null);setIsAnimating(false);setCurrentAnimIdx(null);setAnimationSteps([]);setCurrentStepIndex(-1);setMessage('')},[initialSeeds]);
