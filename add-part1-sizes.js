...
console.log('📐 Parte 1: Adicionando Tamanhos de Tabuleiro...\n');
...
// 2. Adicionar BOARD_SIZES após THEMES
...
app = app.slice(0, insertPoint) + boardSizesConfig + app.slice(insertPoint);
console.log('✅ BOARD_SIZES adicionado');
...
console.log('\n📐 Opções disponíveis:');
console.log('  - Iniciante 4x4 (16 casas)');
console.log('  - Classico 4x6 (24 casas)');
console.log('  - Medio 4x8 (32 casas)');
console.log('  - Grande 4x10 (40 casas)');
