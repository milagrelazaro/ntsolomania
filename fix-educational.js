...
console.log('🔧 Corrigindo inserção de configurações educativas...\n');

let app = fs.readFileSync('App.js', 'utf8');

// Encontrar o FINAL da definição de THEMES (após ocean:})
const themesEnd = app.indexOf('},ocean:');
const insertPoint = app.indexOf('}', themesEnd) + 1;
...
app = app.slice(0, insertPoint) + '};' + educationalConfig + app.slice(insertPoint + 1);
console.log('✅ Configuracoes educativas inseridas apos THEMES');

// Modificar aiChooseMove
